...
public class GPSTracker1 implements LocationListener {
    public long lastTimeLocationChanged = -1;
    public static String tag = "afr";
    ...
    private static final long MIN_TIME_BW_UPDATES = 1000*0; // 20 sec
